...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2017 a las 00:58:25
...
--
-- Estructura de tabla para la tabla `ins_docentes`
--

CREATE TABLE `ins_docentes` (
  `docentes_id` int(11) NOT NULL,
  `docentes_nickname` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_tidentificacion` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_identificacion` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_nombres` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_apellidos` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_departamento` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_ciudad` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_direccion` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_barrio` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_telefono` int(12) DEFAULT NULL,
  `docentes_correo` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `docentes_password` varchar(255) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

--
-- Volcado de datos para la tabla `ins_docentes`
--

INSERT INTO `ins_docentes` (`docentes_id`, `docentes_nickname`, `docentes_tidentificacion`, `docentes_identificacion`, `docentes_nombres`, `docentes_apellidos`, `docentes_departamento`, `docentes_ciudad`, `docentes_direccion`, `docentes_barrio`, `docentes_telefono`, `docentes_correo`, `docentes_password`) VALUES
...
(3, 'xlifems', '1', '2365987', 'Marci Maria', 'Masa Pico', '4', '135', 'cl 12  15 - 24', 'chimalito', 7789654, 'adr@gmail.com', '123456'),
(4, 'mas', '1', '123654756', 'denise', 'pico', '5', '158', 'cl 12  15 - 24', 'chimalito', 3265874, 'deni@gmai.com', '1234');
...
(20, 5, 'Lluvias', 'porque', '2000-01-01 05:00:00'),
(21, 6, 'No esta en la ciudad', '5', '2000-01-01 05:00:00'),
(22, 5, 'Vueltas personales', 'y', '2000-01-01 05:00:00'),
(23, 5, 'No esta en la ciudad', '5', '2000-01-01 05:00:00'),
(24, 8, 'Vueltas personales', '5', '2000-01-01 05:00:00'),
(25, 7, 'Lluvias', '5', '2000-01-01 05:00:00'),
(26, 7, 'Esta enfermo', 'si', '2000-01-01 05:00:00'),
(27, 8, 'Otra cual', 'Perro', '2000-01-01 05:00:00'),
(28, 8, 'No esta en la ciudad', '5', '2000-01-01 05:00:00'),
(29, 8, 'Lluvias', '5', '2000-01-01 05:00:00'),
(30, 7, 'Lluvias', '5', '2000-01-01 05:00:00'),
(31, 7, 'Vueltas personales', '5', '2000-01-01 05:00:00'),
(32, 8, 'No esta en la ciudad', '5', '2000-01-01 05:00:00'),
(33, 5, 'Lluvias', '5', '2000-01-01 05:00:00'),
(34, 7, 'Lluvias', '5', '2000-01-01 05:00:00'),
(35, 7, 'Lluvias', '5', '2000-01-01 05:00:00'),
(36, 7, 'Lluvias', '5', '2000-01-01 05:00:00'),
(37, 8, 'Esta enfermo', '5', '2000-01-01 05:00:00'),
(38, 5, 'Lluvias', 'si', '2000-01-01 05:00:00'),
(39, 6, 'Lluvias', '5', '2000-01-01 05:00:00'),
(40, 5, 'Esta enfermo', '5', '2000-01-01 05:00:00'),
(41, 7, 'Lluvias', 'muchas', '2000-01-01 05:00:00'),
(42, 6, 'Lluvias', '', '2000-01-01 05:00:00'),
(43, 6, 'Lluvias', '', '2000-01-01 05:00:00'),
(44, 7, 'Lluvias', '', '2000-01-01 05:00:00'),
(45, 5, 'Lluvias', '', '2000-01-01 05:00:00'),
(46, 6, 'Lluvias', '', '2000-01-01 05:00:00'),
(47, 6, 'Lluvias', '', '2000-01-01 05:00:00'),
(48, 6, 'Lluvias', '', '2000-01-01 05:00:00'),
(49, 8, 'Lluvias', '', '2000-01-01 05:00:00');
...
INSERT INTO `ins_niveles` (`id_nivel`, `nombre_nivel`, `docentes_id`) VALUES
(1, '1-01', 1),
(2, '2-01', 1),
(3, '3-01', 1),
(4, '4-01', 1),
...
CREATE TABLE `ins_usuarios` (
  ...
  `usuario_nivel_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `ins_usuarios` (`usuario_id`, `usuario_nickname`, `usuario_tidentificacion`, `usuario_identificacion`, `usuario_nombres`, `usuario_apellidos`, `usuario_departamento`, `usuario_ciudad`, `usuario_direccion`, `usuario_barrio`, `usuario_telefono`, `usuario_correo`, `usuario_password`, `usuario_nivel_id`) VALUES
(5, 'adrianmasapico@gmail.com', '1', '123456', 'Felix Adrian', 'Masa Pico', '6', '205', 'KR 43 A # 16 A SUR - 38', 'chimalito', 2147483647, 'adrianmasapico@gmail.com', '890504', 1),
(6, 'jove', '1', '123456', 'joverti', 'Doria Pico', '5', '163', 'KR 43 A # 16 A SUR - 38, OF 203 SERVINFORMACION', 'chimalito', 2147483647, 'adr@gmail.com', '1234', 2),
(7, '5', '2', '123456987', 'Pepito pepe', 'hernandez mangonez', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(8, 'hmejiaespriella22@gmail.com ', '1', '78025654', 'Hernan manuel', 'mejia espriella', '19', '709', 'kr 16 56 98 ', 'alto kenneddy', 300256987, 'hmejiaespriella22@gmail.com', '1234', 1),
(9, 'hmejiaespriella22@gmail.com ', '1', '78025654', 'Carlos javier', 'Perez Martinez', '19', '709', 'kr 16 56 98 ', 'alto kenneddy', 300256987, 'hmejiaespriella22@gmail.com', '1234', 1),
(10, 'xlifems', '1', '1063150552', 'Marci Maria', 'Masa Pico', '19', '691', 'chimalito', 'chimalito', 236589741, 'adr@gmail.com', '123456', 2),
(12, 'mas', '1', '123654756', 'denise', 'pico', '5', '158', 'cl 12  15 - 24', 'chimalito', 3265874, 'deni@gmai.com', '1234', 1);
...
--
-- Indices de la tabla `ins_docentes`
--
ALTER TABLE `ins_docentes`
...
--
-- AUTO_INCREMENT de la tabla `ins_docentes`
--
ALTER TABLE `ins_docentes`
  MODIFY `docentes_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `ins_faltas`
--
ALTER TABLE `ins_faltas`
  MODIFY `falta_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
